            ...
            >
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-end">
                  <a rel="noopener noreferrer" href="#" className="text-gray-400 hover:text-gray-100 no-underline">
                    Forgot Password?
                  </a>
                </div>
              </div>
              <button className="block w-full p-3 font-medium text-center rounded-sm text-gray-900 bg-blue-500">
                Sign in
              </button>
            </form>
